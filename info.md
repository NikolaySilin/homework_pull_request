...
Перенос файлов из одного репозитория в другой:

>git remote add [**имя нового ремоута**] [**ссылка на репозиторий из какого хотите скопировать**]

>git fetch [**имя нового ремоута**]

>git merge [**имя нового ремоута**]/master --allow-unrelated-histories
